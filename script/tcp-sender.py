...
# 发送带有特定TOS值的TCP数据
def send_max_tcp(ifname, dest_ip, dest_port=12345, tos_value=0x68, payload_size=None):  # 0x68 = 0b01101000
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ifname", default="eth0", help="网卡名称 (默认: eth4)")
    parser.add_argument("--ip", default="192.168.1.93", help="目标IP地址 (默认: 192.168.1.93)")
